...
extension NKPublishers {
    ...
    public struct CombineLatest3<A: NKPublisher, B: NKPublisher, C: NKPublisher>: NKPublisher where A.Failure == B.Failure, B.Failure == C.Failure {
        ...
        public func receive<S: NKSubscriber>(subscriber: S) where Output == S.Input, Failure == S.Failure {
            ...
            typealias Sub = CombineLatestSink3<S, A.Output, B.Output, C.Output, Failure>
...
extension NKPublishers.CombineLatest3: Equatable where A: Equatable, B: Equatable, C: Equatable {
    
    public static func == (lhs: NKPublishers.CombineLatest3<A, B, C>, rhs: NKPublishers.CombineLatest3<A, B, C>) -> Bool {
