...
extension NKPublishers {
    ...
    public struct Zip5<A: NKPublisher, B: NKPublisher, C: NKPublisher, D: NKPublisher, E: NKPublisher>: NKPublisher where A.Failure == B.Failure, B.Failure == C.Failure, C.Failure == D.Failure, D.Failure == E.Failure {
        ...
        public func receive<S: NKSubscriber>(subscriber: S) where Output == S.Input, Failure == S.Failure {
            ...
            typealias Sub = ZipSink5<S, A.Output, B.Output, C.Output, D.Output, E.Output, Failure>
...
extension NKPublishers.Zip5: Equatable where A: Equatable, B: Equatable, C: Equatable, D: Equatable, E: Equatable {
    
    public static func == (lhs: NKPublishers.Zip5<A, B, C, D, E>, rhs: NKPublishers.Zip5<A, B, C, D, E>) -> Bool {
