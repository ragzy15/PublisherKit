...
extension NKPublishers {
    ...
    public struct Zip4<A: NKPublisher, B: NKPublisher, C: NKPublisher, D: NKPublisher>: NKPublisher where A.Failure == B.Failure, B.Failure == C.Failure, C.Failure == D.Failure {
...
extension NKPublishers.Zip4: Equatable where A: Equatable, B: Equatable, C: Equatable, D: Equatable {
    
    public static func == (lhs: NKPublishers.Zip4<A, B, C, D>, rhs: NKPublishers.Zip4<A, B, C, D>) -> Bool {
