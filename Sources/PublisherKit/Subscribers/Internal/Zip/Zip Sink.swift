...
class ZipSink<Downstream: PKSubscriber, AInput, BInput, Failure>: InternalSink<Downstream, (AInput, BInput), Failure> where Downstream.Input == (AInput, BInput), Downstream.Failure == Failure {
